...
let randomisedColor = ['#007ACC', '#465362', '#EDDEA4', '#011936']
let i = parseInt(generateRandomInRange(1, 200)%4);
console.log("debug : variable i = ", i)

document.documentElement.style.setProperty('--second-bg-color', randomisedColor[i]);
document.documentElement.style.setProperty('--second-bg-color', randomisedColor[i]);